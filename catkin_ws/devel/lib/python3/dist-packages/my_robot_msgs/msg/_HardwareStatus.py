...
class HardwareStatus(genpy.Message):
  _md5sum = "2bc72ec2d9975b511745c94cc00f1be1"
  _type = "my_robot_msgs/HardwareStatus"
  _has_header = False  # flag to mark the presence of a Header object
  _full_text = """int64 temprature
bool are_motors_up
string debug_message"""
  __slots__ = ['temprature','are_motors_up','debug_message']
  ...
  def __init__(self, *args, **kwds):
    ...
    The available fields are:
       temprature,are_motors_up,debug_message
  ...
  def serialize(self, buff):
    ...
    try:
      _x = self
      buff.write(_get_struct_qB().pack(_x.temprature, _x.are_motors_up))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.temprature, _x.are_motors_up,) = _get_struct_qB().unpack(str[start:end])
